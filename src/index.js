...
import { isMobile } from "./lib/utils/validation";
...
import { ExecuteOnConsentHookOnPageLoad } from "./lib/core";
    ...
    _init: function() {
      ...
      xhr.onload = () => {
        if (xhr.status >= 200 && xhr.status < 300) {
          ...
          ExecuteOnConsentHookOnPageLoad(this.transformedPurposes, this.config);
          ...
          this._initEvents(this.transformedPurposes, this.config);
